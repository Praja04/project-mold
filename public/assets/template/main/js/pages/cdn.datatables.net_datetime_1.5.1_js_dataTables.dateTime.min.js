...
!(function (s) {
  ...
  function a(t, e) {
    ...
    'string' == typeof this.c.minDate && (this.c.minDate = new Date(this.c.minDate)), 'string' == typeof this.c.maxDate && (this.c.maxDate = new Date(this.c.maxDate));
    var s = g(
      '<div class="' +
        e +
        '"><div class="' +
  ...
  return (
    g.extend(a.prototype, {
      destroy: function () {
        this._hide(!0), this.dom.container.off().empty(), this.dom.input.removeClass('dt-datetime').removeAttr('autocomplete').off('.datetime');
      },
      display: function (t, e) {
        return (
          t !== n && this.s.display.setUTCFullYear(t),
          e !== n && this.s.display.setUTCMonth(e - 1),
          t !== n || e !== n ? (this._setTitle(), this._setCalander(), this) : { month: this.s.display.getUTCMonth() + 1, year: this.s.display.getUTCFullYear() }
        );
      },
      errorMsg: function (t) {
      ...
      val: function (t, e) {
        return t === n
          ...
          : (t instanceof Date
            ...
            (!e && e !== n) || (this.s.d ? this._writeOutput() : this.dom.input.val(t)),
            ...
            .on('click', function (t) {
              ...
              if ('select' !== i)
                if (
                  ...
                  'a' === i &&
                    (t.preventDefault(),
                    g(s).hasClass(r + '-clear') ? ((o.s.d = null), o.dom.input.val(''), o._writeOutput(), o._setCalander(), o._setTime(), a()) : g(s).hasClass(r + '-today') && ((o.s.display = new Date()), o._setTitle(), o._setCalander())),
                  'button' === i)
                ) {
                  (t = g(s)), (i = t.parent());
                  if (i.hasClass('disabled') && !i.hasClass('range')) t.blur();
                    ...
                    if (t.parents('.' + r + '-time').length) {
                      var s = t.data('value'),
                        ...
                        e = o._needValue();
                      if ('minutes' === n) {
                        if (i.hasClass('disabled') && i.hasClass('range')) return (o.s.minutesRange = s), void o._setTime();
                        o.s.minutesRange = null;
                      }
                      if ('seconds' === n) {
                        if (i.hasClass('disabled') && i.hasClass('range')) return (o.s.secondsRange = s), void o._setTime();
                      ...
                      e['hours' === n ? 'setUTCHours' : 'minutes' === n ? 'setUTCMinutes' : 'setSeconds'](s), o._setCalander(), o._setTime(), o._writeOutput(!0);
                    } else
      ...
      _convert: function (t, e, s) {
        ...
        return (
          ...
          (r
            ? this._isLuxon()
              ? (i = t instanceof Date ? r.DateTime.fromJSDate(t).toUTC() : r.DateTime.fromFormat(t, e)).isValid
                ? s
                  ? i.toFormat(s)
                  : i.toJSDate()
                : null
              : (i = t instanceof Date ? r.utc(t, n, this.c.locale, this.c.strict) : r(t, e, this.c.locale, this.c.strict)).isValid()
              ? s
                ? i.format(s)
                : i.toDate()
              : null
      ...
      _htmlMonth: function (t, e) {
        for (var s = this._dateToUtc(new Date()), i = this._daysInMonth(t, e), n = new Date(Date.UTC(t, e, 1)).getUTCDay(), a = [], o = [], r = (0 < this.c.firstDay && (n -= this.c.firstDay) < 0 && (n += 7), i + n), d = r; 7 < d; ) d -= 7;
        r += 7 - d;
        var l = this.c.minDate,
          h = this.c.maxDate;
        l && (l.setUTCHours(0), l.setUTCMinutes(0), l.setSeconds(0)), h && (h.setUTCHours(23), h.setUTCMinutes(59), h.setSeconds(59));
        for (var u = 0, c = 0; u < r; u++) {
          var m = new Date(Date.UTC(t, e, u - n + 1)),
            ...
            f = { day: u - n + 1, month: e, year: t, selected: f, today: p, disabled: (T = (Array.isArray(_) && -1 !== g.inArray(m.getUTCDay(), _)) || ('function' == typeof _ && !0 === _(m)) ? !0 : T), empty: y };
          o.push(this._htmlDay(f)), 7 == ++c && (this.c.showWeekNumber && o.unshift(this._htmlWeekOfYear(u - n, e, t)), a.push('<tr>' + o.join('') + '</tr>'), (o = []), (c = 0));
        }
        var v,
        ...
        return (
          ...
          l && ((v = l >= new Date(Date.UTC(t, e, 1, 0, 0, 0))), this.dom.title.find('div.' + D + '-iconLeft').css('display', v ? 'none' : 'block')),
          h && ((v = h < new Date(Date.UTC(t, e + 1, 1, 0, 0, 0))), this.dom.title.find('div.' + D + '-iconRight').css('display', v ? 'none' : 'block')),
          '<table class="' + C + '"><thead>' + this._htmlMonthHead() + '</thead><tbody>' + a.join('') + '</tbody></table>'
        );
      },
      ...
      _htmlWeekOfYear: function (t, e, s) {
        (e = new Date(s, e, t, 0, 0, 0, 0)), e.setDate(e.getDate() + 4 - (e.getDay() || 7)), (t = new Date(s, 0, 1)), (s = Math.ceil(((e - t) / 864e5 + 1) / 7));
          ...
          var u = '',
            ...
            m = function (t, e, s) {
              ...
              return (
                ...
                s && (i += ' ' + s),
                '<td class="selectable ' + i + '"><button class="' + d + '-button ' + d + '-day" type="button" data-unit="' + n + '" data-value="' + t + '"><span>' + e + '</span></button></td>'
              );
            };
          if (12 === a) {
      ...
      _position: function () {
        ...
        n.hasClass('inline')
          ...
          : (this.s.parts.date && this.s.parts.time && 550 < g(o).width() ? n.addClass('horizontal') : n.removeClass('horizontal'),
            'input' === this.c.attachTo ? n.css({ top: i.top + a, left: i.left }).insertAfter(this.dom.input) : n.css({ top: i.top + a, left: i.left }).appendTo('body'),
            (t = n.outerHeight()),
            (e = n.outerWidth()),
            (s = g(o).scrollTop()),
            i.top + a + t - s > g(o).height() && ((a = i.top - t), n.css('top', a < 0 ? 0 : a)),
            e + i.left > g(o).width() && ((s = g(o).width() - e), 'input' === this.c.attachTo && (s -= g(n).offsetParent().offset().left), n.css('left', s < 0 ? 0 : s)));
      },
      ...
      _setTitle: function () {
        this._optionSet('month', this.s.display.getUTCMonth()), this._optionSet('year', this.s.display.getUTCFullYear());
      },
      _setTime: function () {
        function t(t) {
    ...
    g.fn.dataTable && ((g.fn.dataTable.DateTime = a), (g.fn.DataTable.DateTime = a), g.fn.dataTable.Editor) && (g.fn.dataTable.Editor.DateTime = a),
    a
  );
});
